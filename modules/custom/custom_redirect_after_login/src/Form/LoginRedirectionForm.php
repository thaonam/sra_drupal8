...
namespace Drupal\custom_redirect_after_login\Form;
 ...
 *
 * @package Drupal\custom_redirect_after_login\Form
 */
class LoginRedirectionForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('custom_redirect_after_login.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('custom_redirect_after_login.settings')
  ...
  protected function getEditableConfigNames() {
    return ['custom_redirect_after_login.settings'];
  }
